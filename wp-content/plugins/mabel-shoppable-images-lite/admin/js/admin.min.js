...
var SIWCAdmin;!function(e){var t=Core.Admin.Components.MediaSelector,a=Core.Admin.Components.StepTracker,i=function(){function i(i){var r=this;this.home=i;this.clamped=!1,jQuery.views.settings.allowCode(!0),setInterval(function(){var e=i.find(".loader-indicator");e.html("•••"===e.html()?"":e.html()+"•")},155),jQuery.tips({action:"click",element:".tooltip"});var n=new a(i.find(".step-tracker-wrapper#add-image")),c=new e.Controllers.DrawBoard(i),o=new e.Controllers.Lister(i);new t(i.find(".btn-select-image"),function(e){r.activeImage=e.url,r.activeThumb=e.sizes&&e.sizes.thumbnail?e.sizes.thumbnail.url:e.url,i.find(".selected-img-holder img").attr("src",r.activeImage),c.setDrawBoard(),r.mode="create",n.next()});Core.Admin.Dispatcher.subscribe("image:edit",function(t){function a(){this.mode="edit",c.setDrawBoard(),c.setTags(o),n.setStep(2),Core.Admin.Dispatcher.publish("tab:activate","options-addimage")}r.clamped&&r.unclamp();var o=[];i.find(".selected-img-holder img").attr("src",t.image),r.activeImage=t.id;var d=0;t.tags.forEach(function(i,r){var n=new e.Models.Tag;n.percentageX=i.x,n.percentageY=i.y,n.product=new e.Models.Product(i.id,i.name,i.price),n.product.url=i.url,o.push(n),i.id?e.Api.Product.getProductById(i.id).then(function(e){n.product.name=e.name,n.product.price=e.price,++d>=t.tags.length&&a()}):++d>=t.tags.length&&a()})}),i.find(".btn-start-over").on("click",function(e){e.preventDefault(),c.setDrawBoard(),n.setStep(1),r.activeImage=null}),i.find(".btn-save-image").on("click",function(t){t.preventDefault();var a=(jQuery(t.currentTarget),[]);c.getTags().forEach(function(e){if(e.product){var t={x:e.percentageX,y:e.percentageY,id:e.product.id};e.product.id||(t.price=e.product.price,t.name=e.product.name,t.url=e.product.url),a.push(t)}});var i=function(e){o.displayImages(1),r.home.find(".active-shortcode").html('[shoppable_image id="'+e+'"]'),n.next()};if("create"===r.mode){if(o.getTotalImgOnPage()>=2)return;e.Api.Images.addImage(r.activeImage,r.activeThumb,a).then(function(e){i(e)})}else e.Api.Images.updateImage(r.activeImage,a).then(function(){i(r.activeImage)})}),Core.Admin.Dispatcher.subscribe("settings:changed",function(e){c.draw(e)}),Core.Admin.Dispatcher.subscribe("tab:changed",function(e){"options-addimage"===e&&c.draw()}),Core.Admin.Dispatcher.subscribe("images:listed",function(){o.getTotalImgOnPage()>=2?r.clamp():r.unclamp()})}return i.prototype.unclamp=function(){jQuery(".step-tracker-wrapper").show(),jQuery(".upgrade-warning").hide(),this.clamped=!1},i.prototype.clamp=function(){jQuery(".step-tracker-wrapper").hide(),jQuery(".upgrade-warning").show(),this.clamped=!0},i}();e.Main=i}(SIWCAdmin||(SIWCAdmin={})),jQuery(document).ready(function(){new SIWCAdmin.Main(jQuery(document.body))});
