...
var SIWCAdmin;!function(e){var t=Core.Admin.Components.MediaSelector,i=Core.Admin.Components.StepTracker,a=function(){function a(a){var n=this;this.home=a;this.clamped=!1,jQuery.views.settings.allowCode(!0),setInterval(function(){var e=a.find(".loader-indicator");e.html("•••"===e.html()?"":e.html()+"•")},155),jQuery.tips({action:"click",element:".tooltip"});var r=new i(a.find(".step-tracker-wrapper#add-image")),c=new e.Controllers.DrawBoard(a),o=new e.Controllers.Lister(a);new t(a.find(".btn-select-image"),function(e){n.activeImage=e.url,n.activeThumb=e.sizes&&e.sizes.thumbnail?e.sizes.thumbnail.url:e.url,a.find(".selected-img-holder img").attr("src",n.activeImage),c.setDrawBoard(),n.mode="create",r.next()});Core.Admin.Dispatcher.subscribe("image:edit",function(t){function i(){this.mode="edit",c.setDrawBoard(),c.setTags(o),r.setStep(2),Core.Admin.Dispatcher.publish("tab:activate","options-addimage")}n.clamped&&n.unclamp();var o=[];a.find(".selected-img-holder img").attr("src",t.image),n.activeImage=t.id;var d=[];t.tags.forEach(function(e,t){d.push(e.id)});var s=[];e.Api.Product.getProductsByIds(d).then(function(e){s=e}).then(function(){t.tags.forEach(function(t,i){var a=new e.Models.Tag;if(a.percentageX=t.x,a.percentageY=t.y,a.product=new e.Models.Product(t.id,t.name,t.price),a.product.url=t.url,o.push(a),t.id){var n=e.Helpers.Collections.findBy(s,"id",t.id);a.product.name=n.name,a.product.price=n.price}}),i()})}),a.find(".btn-start-over").on("click",function(e){e.preventDefault(),c.setDrawBoard(),r.setStep(1),n.activeImage=null}),a.find(".btn-save-image").on("click",function(t){t.preventDefault();var i=(jQuery(t.currentTarget),[]);c.getTags().forEach(function(e){if(e.product){var t={x:e.percentageX,y:e.percentageY,id:e.product.id};e.product.id||(t.price=e.product.price,t.name=e.product.name,t.url=e.product.url),i.push(t)}});var a=function(e){o.displayImages(1),n.home.find(".active-shortcode").html('[shoppable_image id="'+e+'"]'),r.next()};if("create"===n.mode){if(o.getTotalImgOnPage()>=2)return;e.Api.Images.addImage(n.activeImage,n.activeThumb,i).then(function(e){a(e)})}else e.Api.Images.updateImage(n.activeImage,i).then(function(){a(n.activeImage)})}),Core.Admin.Dispatcher.subscribe("settings:changed",function(e){c.draw(e)}),Core.Admin.Dispatcher.subscribe("tab:changed",function(e){"options-addimage"===e&&c.draw()}),Core.Admin.Dispatcher.subscribe("images:listed",function(){o.getTotalImgOnPage()>=2?n.clamp():n.unclamp()})}return a.prototype.unclamp=function(){jQuery(".step-tracker-wrapper").show(),jQuery(".upgrade-warning").hide(),this.clamped=!1},a.prototype.clamp=function(){jQuery(".step-tracker-wrapper").hide(),jQuery(".upgrade-warning").show(),this.clamped=!0},a}();e.Main=a}(SIWCAdmin||(SIWCAdmin={})),jQuery(document).ready(function(){new SIWCAdmin.Main(jQuery(document.body))});
